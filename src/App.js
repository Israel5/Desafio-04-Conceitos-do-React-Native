...
export default function App() {
  ...
  async function handleLikeRepository(id) {
    ...
    repositoriesArray[repositoryIndex].likes = response.data.likes;
    // console.log(`Like (${repositoriesArray[repositoryIndex].likes}, ${response.data.likes})`)
    // console.log(repositoriesArray[repositoryIndex]);
